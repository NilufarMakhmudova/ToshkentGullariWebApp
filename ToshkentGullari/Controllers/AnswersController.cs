...
namespace ToshkentGullari.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,AdminID,Answer1,QuestionID,TimeAnswered")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,AdminID,Answer1,QuestionID,TimeAnswered")] Answer answer)
        {
            if (ModelState.IsValid)
            {
